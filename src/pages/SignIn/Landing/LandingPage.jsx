        ...
        <div className="p-4">
            ...
            <nav>
                <ul className="space-y-2">
                    <li><a href="#" className="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Home</a></li>
                    <li><a href="#" className="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">About</a></li>
                    <li><a href="#" className="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Services</a></li>
                    <li><a href="#" className="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Contact</a></li>
                </ul>
            </nav>
        </div>
    </div>
